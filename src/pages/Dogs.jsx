...
const dogProducts = [
  {
    ...
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuA1B2C3D4E5F6G7H8I9J0K1L2M3N4O5P6Q7R8S9T0U1V2W3X4Y5Z6A7B8C9D0E1F2G3H4I5J6K7L8M9N0O", 
  },
  {
    id: 2,
  ...
  },
  {
    ...
    tag: "",
    tagColor: "",
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuD9tK4G9zR3QZ8sH9Z7N0K6c7Fz5Q2a5q8R6x9T1Y3b4V8w0L9u7I2p1O5m6N3b8V5c4Z1X9t2B7v0M5n8Z", 
  },
  {
    id: 4,
    name: "Superfood Salmon Treats",
    price: 240000,
    store: "Downtown Boutique",
    weight: "200G",
    tag: "BEST SELLER",
  ...
  return (
    <div className="bg-surface text-on-surface font-body-md min-h-screen flex flex-col">
        ...
        <div className="flex justify-between items-center h-16 px-6 md:px-12 max-w-[1440px] mx-auto">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex gap-6 font-['Plus_Jakarta_Sans'] font-medium text-[13px] tracking-tight">
              ...
              <Link className="text-rose-600 border-b-2 border-rose-600 pb-1" to="/dogs">Dogs</Link>
      ...
      <div className="bg-[#6338b5] text-white text-[10px] font-bold text-center py-2 uppercase tracking-widest flex items-center justify-center gap-2">
        ...
        Premium Rewards: Earn 5% Back On All Dog Essentials Today
      </div>
      ...
      <main className="flex-grow px-6 md:px-12 py-8 max-w-[1440px] mx-auto w-full">
        ...
        <section className="relative rounded-xl overflow-hidden bg-slate-900 h-[320px] flex items-center shadow-md mb-8">
          <div className="absolute inset-0">
            <img className="w-full h-full object-cover opacity-90 mix-blend-overlay" src="https://images.unsplash.com/photo-1548199973-03cce0bbc87b?auto=format&fit=crop&q=80&w=2000" alt="Dog Hero" />
            <div className="absolute inset-0 bg-gradient-to-r from-slate-900/90 via-slate-900/60 to-transparent"></div>
          </div>
          <div className="relative z-10 px-10 md:px-16 max-w-xl">
            <span className="inline-block px-3 py-1 rounded-full bg-rose-600 text-white font-bold text-[9px] mb-4 uppercase tracking-widest">Exclusively For Canines</span>
          ...
          <aside className="w-full lg:w-56 shrink-0">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <span className="border border-slate-200 text-slate-600 text-[10px] font-bold px-2 py-1 rounded-full cursor-pointer hover:border-slate-300">WildRoam</span>
                <span className="border border-slate-200 text-slate-600 text-[10px] font-bold px-2 py-1 rounded-full cursor-pointer hover:border-slate-300">LuxeK9</span>
                <span className="border border-slate-200 text-slate-600 text-[10px] font-bold px-2 py-1 rounded-full cursor-pointer hover:border-slate-300">EcoBark</span>
              </div>
            </div>
          </aside>
