    ...
    <div style={{ display:"flex", gap:"2rem", padding:"2rem 1.5rem", maxWidth:1200, margin:"0 auto" }}>
      ...
      {showSettingsModal && (
        <PengaturanDokterModal
          ...
          idDokter={idDokter}
          dokterSettings={dokterSettings}
          setDokterSettings={setDokterSettings}
          loadData={loadData}
        />
      )}
    </div>
...
// ─── Modal Pengaturan Dokter (QRIS & Bank) (Root-level) ──────────────────────────────────────
function PengaturanDokterModal({ onClose, idDokter, dokterSettings, setDokterSettings, loadData }) {
